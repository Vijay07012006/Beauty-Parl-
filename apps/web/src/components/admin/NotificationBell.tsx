...
export function NotificationBell() {
  ...
  useEffect(() => {
    ...
    // Listen to WebSocket server for live ticket alerts
    ...
    socket.on('new_ticket', (data: any) => {
      toast.info(`🚨 New Ticket #${data.ticketId} from ${data.userName}`, {
        ...
        action: {
          label: 'View',
          onClick: () => {
            window.location.href = `/en/admin/tickets`;
          },
        },
      });

      // Play sci-fi notification alert sound
      try {
              ...
              >
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-primary mt-1.5 flex items-center gap-0.5">
                      <Clock size={10} />
